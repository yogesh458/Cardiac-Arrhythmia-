...
label_5.place(x = 950,y = 400)
    
#Entry_5 = Entry(root,borderwidth=3, relief="solid" )
...
#         output.delete(0,END)
    ...
    label_66 = ttk.Label(root, text =out[0],font=("Helvetica", 26),background="#14161a",foreground="#ffffff")
...
b1 = Button(root, text = 'PREDICT',font=("Helvetica", 16),background="white",command = predict,foreground="black")
